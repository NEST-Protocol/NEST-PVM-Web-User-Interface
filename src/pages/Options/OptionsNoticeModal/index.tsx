      ...
      <MainCard classNames={`${classPrefix}-card`}>
        ...
        <ul>
          ...
          <li>
            ...
            operations, please understand the rules and the differences of
            similar products in the market, and fully understand the following
            possible risks and Participate when you can bear the risk:
          </li>
          <li>
            <Trans>
          ...
          <li>
            <Trans>
              ...
              income at settlement are all used in NEST Token. NEST itself is
              also a volatile asset. In extreme cases, even if your perpetual
              contract position is profitable, it is due to the price of NEST
              itself. Volatility, which may cause you to lose money based on
              legal currency.
            </Trans>
          </li>
          <li>
            <Trans>
              ...
              machine. If the oracle machine is attacked or the price is
              abnormal due to other reasons, the system may experience
              settlement abnormalities, resulting in errors in the user's income
              calculation.
            </Trans>
          </li>
          <li>
