          ...
          >
            ...
            >
              ...
              >
                ...
                <a
                  href={`/#/overview?type=${
                    isNotice === "withdraw" ? "withdraw" : "deposit"
                  }`}
                >
                  <Stack
                    px={"16px"}
                ...
                <Grid item xs={6} md={6} key={index}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ opacity: item.rate !== null ? 1 : 0 }}>
                        {item?.rate > 0 ? "+" : ""}
          ...
          >
            ...
            >
              <Stack direction={"row"} justifyContent={"space-between"}>
                ...
                >
                  {Number(positions?.positionValue ?? 0).toLocaleString(
                    "en-US",
                    {
                      maximumFractionDigits: 2,
                    }
